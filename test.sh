...
# waiting until the clients for lukas and patrick could be started
read -p "Waiting...press enter to continue" dummy
...
# move the car of patrick
printf "\nmoving the car of Patrick to (1,1)\n"
curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache" -H "Postman-Token: 20c866ee-32e8-eaed-40a6-d674fa7e2c88" -d '{
    "x": 1,
    "y": 1
}' "http://localhost:8080/car/move/$patrick"
